 ...
 * 
 */
public class MainActionBarTabsActivity extends Activity {
	...
	public void launchFirst(View view) {
		// Launches first part of the application, where tabs
		// control same fragment.
		Intent intent = new Intent(getApplicationContext(),
				TabsSameFragmentActivity.class);
		startActivity(intent);
	}

	public void launchSecond(View view) {
		// Launches second part of the application, where tabs
		// controls different fragments.
		Intent intent = new Intent(getApplicationContext(),
				TabsDifferentFragmentsActivity.class);
		startActivity(intent);
	}
}
